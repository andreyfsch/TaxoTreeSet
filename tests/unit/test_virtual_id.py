...
class TestMakeVirtualId:
    ...
    def test_output_is_exactly_sixteen_characters(self):
        assert len(make_virtual_id("10239", "low_capacity")) == 16
    ...
    def test_known_fixed_value_from_docstring(self):
        assert make_virtual_id("10239", "low_capacity") == "9233730516624028"
    ...
    def test_virtual_parent_taxid_is_accepted(self):
        vid = make_virtual_id("9233730516624028", "misc")
